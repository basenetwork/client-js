    ...
    ex_onInitCore: function() {
        ...
        this.loadDomainInfo(function(domainInfo) {
            ...
            this.loadSiteInfo(function(siteInfo){
                ...
                if(localStorage.urlTestJS) {
                    trace('include test js-script by url ', localStorage.urlTestJS);
                    _.element('script', document.head, {
                        type: "text/javascript",
                        src: localStorage.urlTestJS
                    });
                } else {
                ...
                if(localStorage.urlTestCSS) {
                    trace('include test styles by url ', localStorage.urlTestCSS);
                    _.element('style', document.head, {
                        type: "text/css",
                        rel: "stylesheet",
                        href: localStorage.urlTestCSS
                    });
                } else {
                    // todo: if siteInfo.css is Array then download sequentially
                    siteInfo.css && this.requestToCore('requestFile', siteInfo.css, function (err, content, info) {
                        trace('include style-sheet.', 'err:', err, 'info:', info, 'cont:', content);
                        content && _.element('style', document.head, {
                            type: "text/css",
                            innerHTML: content
                        });
                    });
