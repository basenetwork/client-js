...
var _ = base._ = {
    ...
    sha256: function(data, enc) {
        if(typeof data === "string") data = CryptoJS.enc.Latin1.parse(data);
        return CryptoJS.SHA256(data).toString(enc || CryptoJS.enc.Hex);
    },

    bintoutf8: function(data) {
        return CryptoJS.enc.Latin1.parse(data).toString(CryptoJS.enc.Utf8);
    },

    bintob64: function(data) {
        return CryptoJS.enc.Latin1.parse(data).toString(CryptoJS.enc.Base64);
    },

    bin: function(data) {
        return CryptoJS.enc.Utf8.parse(this.str(data)).toString(CryptoJS.enc.Latin1);
    },
